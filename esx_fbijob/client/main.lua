  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('::{korioz#0110}::esx_fbijob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    ESX.TriggerServerCallback('::{korioz#0110}::esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('::{korioz#0110}::esx_society:removeVehicleFromGarage', 'fbi', vehicleProps)
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						TriggerServerEvent('::{korioz#0110}::esx_fbijob:handcuff', GetPlayerServerId(closestPlayer))
					elseif action == 'drag' then
						TriggerServerEvent('::{korioz#0110}::esx_fbijob:drag', GetPlayerServerId(closestPlayer))
					elseif action == 'put_in_vehicle' then
						TriggerServerEvent('::{korioz#0110}::esx_fbijob:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						TriggerServerEvent('::{korioz#0110}::esx_fbijob:OutVehicle', GetPlayerServerId(closestPlayer))
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('::{korioz#0110}::esx_fbijob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('::{korioz#0110}::esx_billing:sendBill', GetPlayerServerId(player), 'society_fbi', _U('fine_total', label), amount)
        else
          TriggerServerEvent('::{korioz#0110}::esx_billing:sendBill', GetPlayerServerId(player), '', _U('fine_total', label), amount)
        end
...
function LookupVehicle()
	...
	'dialog', GetCurrentResourceName(), 'lookup_vehicle',
	{
		...
		if data.value == nil or length < 8 or length > 13 then
			...
			ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getVehicleFromPlate', function(owner, found)
				if found then
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getOtherPlayerData', function(data)
		...
		function(data, menu)
			...
			TriggerServerEvent('::{korioz#0110}::esx_fbijob:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
			
			TriggerServerEvent('::{korioz#0110}::esx_license:removeLicense', GetPlayerServerId(player), data.current.value)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
  ...
  ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('::{korioz#0110}::esx_fbijob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('::{korioz#0110}::esx_fbijob:putStockItems', itemName, count)
            end
...
AddEventHandler('::{korioz#0110}::esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('::{korioz#0110}::esx_fbijob:forceBlip')
end)
...
AddEventHandler('::{korioz#0110}::esx_fbijob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('::{korioz#0110}::esx_fbijob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('::{korioz#0110}::esx_fbijob:hasEnteredEntityZone', function(entity)
...
AddEventHandler('::{korioz#0110}::esx_fbijob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('::{korioz#0110}::esx_fbijob:handcuff')
AddEventHandler('::{korioz#0110}::esx_fbijob:handcuff', function()
...
AddEventHandler('::{korioz#0110}::esx_fbijob:unrestrain', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
RegisterNetEvent('::{korioz#0110}::esx_fbijob:drag')
AddEventHandler('::{korioz#0110}::esx_fbijob:drag', function(cop)
...
RegisterNetEvent('::{korioz#0110}::esx_fbijob:putInVehicle')
AddEventHandler('::{korioz#0110}::esx_fbijob:putInVehicle', function()
...
RegisterNetEvent('::{korioz#0110}::esx_fbijob:OutVehicle')
AddEventHandler('::{korioz#0110}::esx_fbijob:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'fbi' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('::{korioz#0110}::esx_fbijob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('::{korioz#0110}::esx_fbijob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('::{korioz#0110}::esx_fbijob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('::{korioz#0110}::esx_fbijob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'fbi' then
				...
				elseif CurrentAction == 'delete_vehicle' then
					if Config.EnableSocietyOwnedVehicles then
						...
						TriggerServerEvent('::{korioz#0110}::esx_society:putVehicleInGarage', 'fbi', vehicleProps)
					else
						...
						then
							TriggerServerEvent('::{korioz#0110}::esx_service:disableService', 'fbi')
						end
					end
					ESX.Game.DeleteVehicle(CurrentActionData.vehicle)
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('::{korioz#0110}::esx_society:openBossMenu', 'fbi', function(data, menu)
						menu.close()
						CurrentAction     = 'menu_boss_actions'
						CurrentActionMsg  = _U('open_bossmenu')
						CurrentActionData = {}
...
RegisterNetEvent('::{korioz#0110}::esx_fbijob:updateBlip')
AddEventHandler('::{korioz#0110}::esx_fbijob:updateBlip', function()
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('::{korioz#0110}::esx_fbijob:unrestrain')
	
	if not hasAlreadyJoined then
		TriggerServerEvent('::{korioz#0110}::esx_fbijob:spawned')
	end
